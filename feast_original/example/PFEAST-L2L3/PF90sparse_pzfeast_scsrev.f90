...
!!!!!!!!!!!!! FEAST  
 call pfeastinit(fpm,MPI_COMM_WORLD,nL3)
  fpm(1)=1  
  call pzfeast_scsrev(UPLO,N,sa,isa,jsa,fpm,epsout,loop,Emid,r,M0,E,XR,M,res,info)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  if ((info/=0).and.(rank==0)) print *,'PF90sparse_pzfeast_scsrev -- failed'
  if ((info==0).and.(rank==0)) then
     print *,'PF90sparse_pzfeast_scsrev -- success'
     print *,'*************************************************'
     print *,'************** REPORT ***************************'
     print *,'*************************************************'
